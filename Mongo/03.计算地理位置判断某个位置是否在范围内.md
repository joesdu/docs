> 在日常开发中可能会遇到定位考勤等问题.但是使用圆形的范围计算不太精确.这个时候我们就可以使用 Mongodb 的地理位置计算功能了.

这里我们使用自己调整过的[EasilyNET.Mongo](https://github.com/EasilyNET/EasilyNET.Mongo),也可以使用 Nuget 安装.
